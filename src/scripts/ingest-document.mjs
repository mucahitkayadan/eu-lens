...
function updateDocumentRegistry(metadata: DocumentMetadata) {
  const registryPath = join(rootDir, 'data', 'document-registry.json')
  let registry: DocumentMetadata[] = []
...
async function ingestDocument(url: string, name: string, force: boolean = false) {
